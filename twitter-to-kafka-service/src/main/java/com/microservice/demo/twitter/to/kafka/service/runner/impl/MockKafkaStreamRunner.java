...
public class MockKafkaStreamRunner implements StreamRunner {
    ...
    //https://lipsum.com/ random word generator
    private static final String[] WORDS = new String[] {
            "Suspendisse", "potenti.", "Curabitur", "convallis", "ut", "odio", "vel,", "mollis.", "Donec", "quis."
    };
    ...
    public MockKafkaStreamRunner(TwitterToKafkaServiceConfigData configData, TwitterKafkaStaticListener statusListener) {
        ...
        Executors.newSingleThreadExecutor().submit(() ->{
            try {
                while(true){
                    ...
                    twitterKafkaStaticListener.onStatus(status);
                    sleep(sleepTimeMs);
                }
